...
```{r}
trControl <- trainControl(method = "repeatedcv", number = 10, repeats = 5, verboseIter = T, savePredictions = "final")
...
results[6,] = data.frame(getTrainPerf(fit6), Name = paste0("fit6"), QC = "4th_root + PCA outlier removal + Bad features removal + QC and Bind samples + Row Normalization OG method")
